...
export class PublicationBook {
    ...
    toTEI(request) {
        ...
        switch (this.canon) {
            case 'OT':
                content = this.processRowsToXml(request, PublicationHebrewWordElement.fromWordRow);
                break;
            case 'NT':
                content = this.processRowsToXml(request, PublicationGreekWordElement.fromWordRow);
                break;
            default:
    ...
    processRowsToXml(request, objectCreator) {
        ...
        const doc = create({ version: '1.0', encoding: 'UTF-8' })
            ...
            .ele('text')
            .ele('body');
        this.hopper.forEach((chapter, chapterIndex) => {
...
//# sourceMappingURL=PublicationBook.js.map